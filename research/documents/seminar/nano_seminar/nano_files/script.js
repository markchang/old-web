...
var gDocTable = new Array(
   ...
   new hrefList("slide0015.htm", 1, 6),
   new hrefList("slide0022.htm", 1, 7),
   new hrefList("slide0016.htm", 1, 8),
   new hrefList("slide0007.htm", 1, 9),
   new hrefList("slide0017.htm", 1, 10),
   new hrefList("slide0028.htm", 1, 11),
   new hrefList("slide0018.htm", 1, 12),
   new hrefList("slide0021.htm", 1, 13),
   new hrefList("slide0020.htm", 1, 14),
   ...
   new hrefList("slide0008.htm", 1, 20),
   new hrefList("slide0009.htm", 1, 21)
);
