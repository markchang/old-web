...
var gDocTable = new Array(
   ...
   new hrefList("slide0007.htm", 0, 0),
   new hrefList("slide0008.htm", 0, 0),
   new hrefList("slide0009.htm", 0, 0),
   new hrefList("slide0010.htm", 1, 7),
   new hrefList("slide0011.htm", 1, 8),
   new hrefList("slide0012.htm", 1, 9),
   new hrefList("slide0013.htm", 1, 10),
   new hrefList("slide0014.htm", 1, 11),
   new hrefList("slide0015.htm", 1, 12),
   new hrefList("slide0016.htm", 1, 13),
   new hrefList("slide0017.htm", 1, 14),
   new hrefList("slide0018.htm", 1, 15),
   new hrefList("slide0019.htm", 1, 16),
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Game%20Theory_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Game%20Theory_files/error.htm" );
	}
	else {
