...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=27, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0015.htm", 1, 14),
   ...
   new hrefList("slide0020.htm", 1, 19),
   new hrefList("slide0021.htm", 1, 20),
   new hrefList("slide0025.htm", 1, 21),
   new hrefList("slide0026.htm", 1, 22),
   new hrefList("slide0027.htm", 1, 23),
   new hrefList("slide0022.htm", 1, 24),
   new hrefList("slide0028.htm", 1, 25),
   new hrefList("slide0029.htm", 1, 26),
   new hrefList("slide0023.htm", 1, 27)
);
